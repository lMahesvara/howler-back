...
export const followUser = async (req, res) => {
  ...
  if (!idUserFollow) {
    return res
      .status(400)
      .json({ message: 'Please provide an userID to follow' })
  }

  if (!idUser) {
    return res
      .status(400)
      .json({ message: 'Please provide an userID to add the follow' })
  }
...
export const getFollowers = async (req, res) => {
  ...
  if (!idUser) {
    return res
      .status(400)
      .json({ message: 'Please provide an userID to fetch its followers' })
  }
...
export const getFollowing = async (req, res) => {
  ...
  if (!idUser) {
    return res
      .status(400)
      .json({ message: 'Please provide an userID to fetch its followings' })
  }
...
export const unfollowUser = async (req, res) => {
  ...
  if (!idUserUnfollow) {
    return res
      .status(400)
      .json({ message: 'Please provide an userID to unfollow' })
  }

  if (!idUser) {
    return res
      .status(400)
      .json({ message: 'Please provide an userID who will unfollow' })
  }
